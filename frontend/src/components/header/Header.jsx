...
const Header = () => {
  ...
  const {cart, logout, on} = useContext(ShopContext)


  return (
   <>
      <div className={`w-full xl:h-[71px] h-[71px] ${on ? "bg-black text-white" : "bg-white"} manjari`}>
    ...
    <div className='hidden xl:flex w-full h-full'>
      <div className='h-full w-full between '>
            ...
            <div className='h-full flex justify-start items-center w-[28%]  gap-6 '>
                <div className='centered cursor-pointer'>
