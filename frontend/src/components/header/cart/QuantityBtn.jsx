...
<form className="xl:max-w-xs mx-auto manjari w-[80px] xl:w-full">
    ...
    <div className="relative flex items-center max-w-[8rem]">
        ...
        <button type="button" id="increment-button" data-input-counter-increment="quantity-input" className="bg-gray-100 dark:bg-gray-700 dark:hover:bg-gray-600 dark:border-gray-600 hover:bg-gray-200 border border-gray-300 rounded-e-lg  xl:p-3 p-1 xl:h-11 h-6 focus:ring-gray-100 dark:focus:ring-gray-700 focus:ring-2 focus:outline-none">
