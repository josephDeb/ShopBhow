...
<form className="max-w-xs mx-auto manjari">
    <label htmlFor="quantity-input" className="block mb-2 text-sm font-medium text-gray-900 dark:text-black">Choose quantity:</label>
