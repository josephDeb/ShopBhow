...
const UserLoginForm = () => {
    ...
    const handleSubmit = (e) => {
      e.preventDefault()
      axios.post("http://localhost:8088/user/userlogin", values)
      .then(result => {
    ...
    <div className="relative flex flex-col justify-center max-w-screen-xl mx-auto min-h-screen overflow-hidden">
            ...
            <div className="w-[88%] p-6 m-auto bg-white/50 rounded-md shadow-xl lg:max-w-sm">
                ...
                <form onSubmit={handleSubmit} className="mt-6">
                    ...
                    <div className="mt-2">
                        <button className="w-full px-4 py-2 tracking-wide text-white transition-colors duration-200 transform bg-red-700 rounded-md hover:bg-red-600 focus:outline-none focus:bg-red-500">
                            Login
                        </button>
                    </div>
                </form>
                <div className="relative flex items-center justify-center w-full mt-6 border-black border-t">
